...
SWIGEXPORT jlong JNICALL Java_com_zhuxin_mitprotocol_mitprotocolJNI_MitProtocolInterface_1GetDat(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  jlong jresult = 0 ;
  MitProtocolInterface *arg1 = (MitProtocolInterface *) 0 ;
  int arg2 ;
  std::deque< int > *result = 0 ;
  ...
  arg1 = *(MitProtocolInterface **)&jarg1; 
  arg2 = (int)jarg2; 
  result = (std::deque< int > *) &(arg1)->GetDat(arg2);
  *(std::deque< int > **)&jresult = result; 
  return jresult;
}
