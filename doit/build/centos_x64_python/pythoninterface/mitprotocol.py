...
class MitProtocolInterface(_object):
    ...
    def SetMitTarFilePathAndName(self, mitTarFilePathAndName, isWrite):
        return _mitprotocol.MitProtocolInterface_SetMitTarFilePathAndName(self, mitTarFilePathAndName, isWrite)

    def GetMitHea(self, sigLen, sigCnt, frequency, gain, adcZero, sigNames, noteLines):
        return _mitprotocol.MitProtocolInterface_GetMitHea(self, sigLen, sigCnt, frequency, gain, adcZero, sigNames, noteLines)

    def GetMitDat(self, channel, sigStartPos, sigLen):
        return _mitprotocol.MitProtocolInterface_GetMitDat(self, channel, sigStartPos, sigLen)

    def GetMitAnn(self, sigStartPos, sigLen):
        return _mitprotocol.MitProtocolInterface_GetMitAnn(self, sigStartPos, sigLen)

    def SetMitAnn(self, annNodes, sigStartPos, sigLen):
        return _mitprotocol.MitProtocolInterface_SetMitAnn(self, annNodes, sigStartPos, sigLen)
